...
HD_PWD='D:/Vivado/mo6-digitaal-ontvangen-controllers/mo6-digitaal-ontvangen-controllers-jochem.runs/design_1_inductieve_sensor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_inductieve_sensor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_inductieve_sensor_0_0.tcl
