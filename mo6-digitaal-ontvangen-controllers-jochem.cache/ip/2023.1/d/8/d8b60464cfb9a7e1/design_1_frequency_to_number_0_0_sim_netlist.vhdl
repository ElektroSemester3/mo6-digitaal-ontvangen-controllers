...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_frequency_to_number is
  ...
  signal \rising_edge_count[9]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \rising_edge_count[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rising_edge_count[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rising_edge_count[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rising_edge_count[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rising_edge_count[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rising_edge_count[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rising_edge_count[9]_i_3\ : label is "soft_lutpair0";
...
\rising_edge_count[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\rising_edge_count[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\rising_edge_count[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\rising_edge_count[9]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\rising_edge_count[9]_i_4\: unisim.vcomponents.LUT6
    generic map(
