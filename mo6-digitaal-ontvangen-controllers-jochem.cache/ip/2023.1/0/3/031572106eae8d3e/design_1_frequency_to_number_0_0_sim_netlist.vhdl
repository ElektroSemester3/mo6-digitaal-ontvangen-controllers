...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^value_out\ : STD_LOGIC_VECTOR ( 8 downto 3 );
...
begin
  ...
  value_out(9) <= \<const0>\;
  value_out(8 downto 3) <= \^value_out\(8 downto 3);
  value_out(2 downto 0) <= \^leds\(3 downto 1);
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_frequency_to_number
     port map (
      Q(9 downto 4) => \^value_out\(8 downto 3),
      Q(3 downto 0) => \^leds\(3 downto 0),
      clk => clk,
      enable => enable,
      freq_in => freq_in,
      reset => reset
